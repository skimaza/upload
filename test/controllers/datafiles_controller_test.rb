...
class DatafilesControllerTest < ActionController::TestCase
  ...
  test "should create datafile" do
    assert_difference('Datafile.count') do
      post :create, datafile: { directory: @datafile.directory, name: @datafile.name, path: @datafile.path }
    end
  ...
  test "should update datafile" do
    patch :update, id: @datafile, datafile: { directory: @datafile.directory, name: @datafile.name, path: @datafile.path }
    assert_redirected_to datafile_path(assigns(:datafile))
  end
