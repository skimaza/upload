  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested log" do
        ...
        Log.any_instance.should_receive(:update).with({ "ip" => "MyString" })
        put :update, {:id => log.to_param, :log => { "ip" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the log as @log" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Log.any_instance.stub(:save).and_return(false)
        put :update, {:id => log.to_param, :log => { "ip" => "invalid value" }}, valid_session
        assigns(:log).should eq(log)
      end
